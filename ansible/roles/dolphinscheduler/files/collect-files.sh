...
docker pull apache/dolphinscheduler-tools:3.2.0 > /dev/null
docker pull apache/dolphinscheduler-api:3.2.0 > /dev/null
docker pull apache/dolphinscheduler-alert-server:3.2.0 > /dev/null
docker pull apache/dolphinscheduler-master:3.2.0 > /dev/null
docker pull apache/dolphinscheduler-worker:3.2.0 > /dev/null
...
docker save \
    ...
    apache/dolphinscheduler-tools:3.2.0 \
